...
def train_model(model, train_loader, val_loader, device, epochs=3, patience=2, lr=0.1):
...
def run_experiment(seed, dataset='cifar10'):
    ...
    converged, best_val = train_model(model, train_loader, val_loader, device, epochs=3, patience=2)
    ...
    _, baseline_val = train_model(baseline_model, train_loader, val_loader, device, epochs=3, patience=2)
